...
CSRCS = ast.c code_gen.c db_file.c db_io.c db_objects.c db_properties.c \
	...
	exceptions.c execute.c extensions.c functions.c keywords.c list.c hash_lookup.c hash.c \
	log.c malloc.c match.c md5.c name_lookup.c network.c net_mplex.c \
	net_proto.c numbers.c objects.c parser.c parse_cmd.c pattern.c program.c profiler.c \
	...
	moomysql.c mysql_child.c serialize.c pipe_utils.c
...
HDRS =  ast.h bf_register.h code_gen.h db.h db_io.h db_private.h decompile.h \
	disassemble.h eval_env.h eval_vm.h exceptions.h execute.h functions.h hash_lookup.h \
	getpagesize.h keywords.h list.h log.h match.h md5.h name_lookup.h hash.h \
	network.h net_mplex.h net_multi.h net_proto.h numbers.h opcode.h \
	options.h parse_cmd.h parser.h pattern.h program.h quota.h random.h profiler.h \
	...
	version.h \
	moomysql.h mysql_child.h serialize.h pipe_utils.h
...
clean:
	rm -f $(OBJS) parser.c keywords.c core y.tab.c y.tab.h y.output makedep eddep 
...
###############################################################################
# $Log: Makefile,v $
# Revision 1.7  2010/05/16 02:39:54  blacklite
# add new files to makefile
#
# Revision 1.6  2009/10/11 00:33:18  blacklite
# update gcc flags (-O2 not -O3 for now), deps, add YSRCS
#
...
execute.o: execute.c my-string.h config.h db.h program.h structures.h \
  ...
  exceptions.h functions.h hash.h list.h log.h numbers.h server.h \
  network.h storage.h ref_count.h streams.h tasks.h timers.h my-time.h \
  utils.h
...
list.o: list.c my-ctype.h config.h my-string.h bf_register.h exceptions.h \
  ...
  opcode.h options.h parse_cmd.h list.h hash.h log.h md5.h pattern.h \
  random.h ref_count.h streams.h storage.h unparse.h utils.h \
  hash_lookup.h
hash_lookup.o: hash_lookup.c hash_lookup.h
hash.o: hash.c my-ctype.h config.h my-string.h my-stdlib.h my-stdarg.h \
  bf_register.h exceptions.h functions.h my-stdio.h execute.h db.h \
  program.h structures.h version.h opcode.h options.h parse_cmd.h hash.h \
  numbers.h list.h log.h md5.h pattern.h random.h ref_count.h streams.h \
  storage.h unparse.h utils.h hash_lookup.h
...
network.o: network.c options.h config.h net_single.c my-ctype.h \
  my-fcntl.h my-stdio.h my-unistd.h log.h structures.h network.h server.h \
  streams.h utils.h execute.h db.h program.h version.h opcode.h \
  parse_cmd.h
net_mplex.o: net_mplex.c options.h config.h
net_proto.o: net_proto.c options.h config.h
